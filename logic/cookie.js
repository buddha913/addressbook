(function () {
      ...
      function buildCookieRows(allData) {
        ...
        Object.keys(allData).forEach(function (fileKey) {
          ...
          function pushRow(base, kind) {
            ...
            // 기간별 수치를 제대로 분리해서 사용
            // - 7D / 14D / 30D: snapsPercent, snapsPercentRank (기간 기준)
            // - TOTAL: snapsPercentTotal, snapsPercentTotalRank (전체 기준)
            var isTotalPeriod = String(period).toUpperCase() === "TOTAL";

            if (kind === "Mindshare") {
              if (isTotalPeriod) {
                rank = base.snapsPercentTotalRank != null ? base.snapsPercentTotalRank : (base.snapsRank != null ? base.snapsRank : base.rank);
                percent = base.snapsPercentTotal != null ? base.snapsPercentTotal : (base.snapsPercent != null ? base.snapsPercent : null);
              } else {
                rank = base.snapsPercentRank != null ? base.snapsPercentRank : (base.snapsRank != null ? base.snapsRank : base.rank);
                percent = base.snapsPercent != null ? base.snapsPercent : (base.snapsPercentTotal != null ? base.snapsPercentTotal : null);
              }
            } else {
              if (isTotalPeriod) {
                rank = base.cSnapsPercentTotalRank != null ? base.cSnapsPercentTotalRank : (base.cSnapsRank != null ? base.cSnapsRank : base.rank);
                percent = base.cSnapsPercentTotal != null ? base.cSnapsPercentTotal : (base.cSnapsPercent != null ? base.cSnapsPercent : null);
              } else {
                rank = base.cSnapsPercentRank != null ? base.cSnapsPercentRank : (base.cSnapsRank != null ? base.cSnapsRank : base.rank);
                percent = base.cSnapsPercent != null ? base.cSnapsPercent : (base.cSnapsPercentTotal != null ? base.cSnapsPercentTotal : null);
              }
            }
      ...
      function renderDashboardCookieForHandle(handleRaw) {
        ...
        ensureLoadedCookieData(function (allData) {
          ...
          sliderWrap.className = "cookie-slider-wrap";
          var track = document.createElement("div");
          track.className = "cookie-slider-track";
